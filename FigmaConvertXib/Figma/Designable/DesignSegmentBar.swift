...
private extension UIView {
  ...
  func selectedView() {
    ...
    self.addInnerShadow(color: #colorLiteral(red: 0.4784313725, green: 0.1960784314, blue: 0.01568627451, alpha: 0.3674445752).cgColor,
                        radius: 9 / 2,
                        offset: CGSize(width: -4, height: -4),
                        cornerRadius: 8)
    
    self.addInnerShadow(color: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0.3720056395).cgColor,
                        radius: 8 / 2,
                        offset: CGSize(width: 4, height: 4),
                        cornerRadius: 8)
  }
